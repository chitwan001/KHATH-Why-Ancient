...
$emails =[];
$count=0;
$query = "SELECT * FROM emails e, emailprops ep,emailreceivers er WHERE e.eid=ep.eid AND e.eid=er.eid AND er.uto=$userid OR e.ufrom = $userid ORDER BY e.stime DESC";
